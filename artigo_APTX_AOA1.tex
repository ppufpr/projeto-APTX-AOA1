...
três etapas: (i) \emph{revisão crítica} do manuscrito original;
(ii) \emph{scripts R e Python} ajuda na criação dos scripts R e Python; e
(iii) \emph{ajustes na formatação} em \LaTeX{}. Todos os resultados numéricos foram
...
\begin{enumerate}
\item ``Revisão crítica do manuscrito original.''
\item ``Ajuda na criação dos script R e Python'' (correção e ajustes em problemas de compilação).
\item ``Ajustes na criação do documento padrão \LaTeX{}''
\end{enumerate}
